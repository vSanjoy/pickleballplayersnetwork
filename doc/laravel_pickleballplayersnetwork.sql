...
--
-- Table structure for table `up_leagues`
--

CREATE TABLE `up_leagues` (
  `id` int(10) UNSIGNED NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slug` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `play_type` enum('S','D') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'D' COMMENT 'S=>Singles, D=>Doubles',
  `gender` enum('M','F','MX') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'M' COMMENT 'M=>Male, F=>Female, MX=>Mixed',
  `rating` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Rating range',
  `rating_start` double(5,2) DEFAULT NULL COMMENT 'Rating start',
  `rating_end` double(5,2) DEFAULT NULL COMMENT 'Rating end',
  `start_date_time` timestamp NULL DEFAULT NULL,
  `end_date_time` timestamp NULL DEFAULT NULL,
  `start_time` int(11) DEFAULT NULL,
  `end_time` int(11) DEFAULT NULL,
  `maximum_registration_allowed` int(11) NOT NULL DEFAULT 30 COMMENT 'Maximum team can register',
  `amount` double(10,2) NOT NULL DEFAULT 2.00 COMMENT 'Registration amount fo the league',
  `league_status` enum('RO','IP','PO','CP') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'RO' COMMENT 'RO=>Registration Open, IP=>In-Progress, PO=>Playoffs, CP=>Complete',
  `sort` int(11) NOT NULL DEFAULT 0,
  `status` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1' COMMENT '0=>Inactive, 1=>Active',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
...
--
-- Dumping data for table `up_leagues`
--

INSERT INTO `up_leagues` (`id`, `title`, `slug`, `zip`, `lat`, `lng`, `state_id`, `state`, `city`, `play_type`, `gender`, `rating`, `rating_start`, `rating_end`, `start_date_time`, `end_date_time`, `start_time`, `end_time`, `maximum_registration_allowed`, `amount`, `league_status`, `sort`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Burbank Pickleballers', 'burbank-pickleballers', 90001, '0.592959', '-2.06384', 5, 'California', 'Los Angeles', 'D', 'M', '3.0 - 4.0', 3.00, 4.00, '2022-06-19 18:30:00', '2022-07-20 18:29:59', 1655708400, 1658386799, 30, 300.00, 'RO', 0, '1', '2022-06-19 22:11:42', '2022-06-20 10:59:56', NULL),
(2, 'Westside Pickle Pros', 'westside-pickle-pros', 90001, '0.592959', '-2.06384', 5, 'California', 'Los Angeles', 'D', 'F', '4.0 - 5.0', 4.00, 5.00, '2022-06-19 18:30:00', '2022-07-20 18:29:59', 1655708400, 1658386799, 20, 200.00, 'RO', 1, '1', '2022-06-19 22:29:44', '2022-06-19 22:29:44', NULL),
(3, 'Palm Springs Old Farts', 'palm-springs-old-farts', 33142, '0.450505', '-1.40043', 10, 'Florida', 'Miami', 'D', 'MX', '2.0 - 3.0', 2.00, 3.00, '2022-06-19 18:30:00', '2022-09-30 18:29:59', 1655708400, 1664607599, 30, 500.00, 'RO', 2, '1', '2022-06-19 22:31:26', '2022-06-19 22:31:26', NULL),
(4, 'Heat of the Valley', 'heat-of-the-valley', 90001, '0.592959', '-2.06384', 5, 'California', 'Los Angeles', 'D', 'F', '5.0 - 100.0', 5.00, 100.00, '2022-06-19 18:30:00', '2022-07-20 18:29:59', 1655708400, 1658386799, 25, 250.00, 'RO', 3, '1', '2022-06-19 23:01:03', '2022-06-20 11:31:58', NULL);
...
(19, '2022_06_19_222641_create_leagues_table', 9),
(20, '2022_06_19_224723_create_ratings_table', 10);
...
--
-- Table structure for table `up_ratings`
--

CREATE TABLE `up_ratings` (
  `id` int(10) UNSIGNED NOT NULL,
  `rating` double(10,2) NOT NULL DEFAULT 2.00,
  `status` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1' COMMENT '0=>Inactive, 1=>Active',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
  `deleted_at` timestamp NULL DEFAULT NULL
...
--
-- Dumping data for table `up_ratings`
--

INSERT INTO `up_ratings` (`id`, `rating`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 2.00, '1', '2022-06-20 05:49:56', NULL, NULL),
(2, 2.25, '1', '2022-06-20 05:49:56', NULL, NULL),
(3, 2.50, '1', '2022-06-20 05:49:56', NULL, NULL),
(4, 2.75, '1', '2022-06-20 05:49:56', NULL, NULL),
(5, 3.00, '1', '2022-06-20 05:49:56', NULL, NULL),
(6, 3.25, '1', '2022-06-20 05:51:40', NULL, NULL),
(7, 3.50, '1', '2022-06-20 05:51:40', NULL, NULL),
(8, 3.75, '1', '2022-06-20 05:51:40', NULL, NULL),
(9, 4.00, '1', '2022-06-20 05:51:40', NULL, NULL),
(10, 4.25, '1', '2022-06-20 05:51:40', NULL, NULL),
(11, 4.50, '1', '2022-06-20 05:51:40', NULL, NULL),
(12, 4.75, '1', '2022-06-20 05:52:07', NULL, NULL),
(13, 5.00, '1', '2022-06-20 05:52:07', NULL, NULL),
(14, 5.25, '1', '2022-06-20 05:52:07', NULL, NULL),
(15, 5.50, '1', '2022-06-20 05:52:07', NULL, NULL);
...
(1, NULL, NULL, 'Adam', 'Klein', 'Adam Klein', NULL, 'admin@pickleballplayersnetwork.com', '9876543210', '$2y$10$FXgoQ/e3ohiSOGmSAAKJaupTyN7iNFBDqUumGRDuqYHlLVl8gNjey', '', 'M', NULL, 2.00, 1, 'UvbfQNGuWtMuDFtItb406tqMXFSuwE6CSWGRUnJsESCZKNbyflzG04jPRPTY', NULL, 'SA', 'Y', 'N', '1', 'N', 1655701103, 'Y', '2022-05-17 01:16:51', '2022-06-19 16:28:23', NULL),
...
--
-- Indexes for table `up_leagues`
--
ALTER TABLE `up_leagues`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `up_ratings`
--
ALTER TABLE `up_ratings`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `up_leagues`
--
ALTER TABLE `up_leagues`
...
--
-- AUTO_INCREMENT for table `up_ratings`
--
ALTER TABLE `up_ratings`
