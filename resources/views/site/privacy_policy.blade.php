...
@section('content')
    ...
    {{-- Start :: Banner section (CMS Privacy policy page) --}}
@if ($cmsDetails->banner_image != null)
    ...
    @endif
@endif
    {{-- End :: Banner section (CMS Privacy policy page) --}}
    <div class="innerContentArea">
        <div class="container">
            <div class="mainContent">
                {{-- Start :: CMS section (CMS Privacy policy page) --}}
                <div class="contentBox">
                    <div class="sec-title">
                        {!! $cmsDetails->description !!}
                    </div>
                </div>
                {{-- End :: CMS section (CMS Privacy policy page) --}}
            </div>
        </div>
    </div>
