...
$(document).ready(function() {
	...
	@include($routePrefix.'.includes.filter_for_player_script')
...
function getList() {
	...
	var dTable = $('#list-table').on('init.dt', function () {$('#dataTableLoading').hide();}).DataTable({
			...
			ajax: {
	        	...
	        	url: getListDataUrl + '?player_rating=' + playerRating + '&home_court=' + homeCourtId,
				type: 'POST',
				data: function(data) {},
	        },
	        columns: [
            ...
            @endif
				...
				{data: 'player_rating', name: 'player_rating'},
				{data: 'home_court', name: 'home_court'},
				{data: 'city', name: 'city'},
				{data: 'created_at', name: 'created_at', orderable: false, searchable: false},
				{data: 'status', name: 'status'},
			@if ($isAllow || in_array('playerType.edit', $allowedRoutes))
