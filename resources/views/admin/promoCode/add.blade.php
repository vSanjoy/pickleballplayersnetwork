					...
					{{ Form::open([
						...
						<div class="form-body mt-4-5">
							...
							<div class="row mt-1">
								<div class="col-md-6">
									<div class="form-group">
										...
										{{ Form::select('is_one_time_use', [
																		...
																		], (old('is_one_time_use')) ? old('is_one_time_use') : 'N',
																		[
																			'id' => 'is_one_time_use',
																			'class' => 'form-control' 
																		]) }}
								...
								<div class="col-md-6">
									<div class="form-group" id="maximum-number-of-use-div" @if (old('is_one_time_use') && old('is_one_time_use') == 'N')style="display: block;" @endif>
										<label class="text-dark font-bold">@lang('custom_admin.label_maximum_number_of_use')<span class="red_star">*</span></label>
                                        {{ Form::text('maximum_number_of_use', null, array(
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										{{ Form::select('discount_type', 
											...
											], (old('discount_type')) ? old('discount_type'):null, array(
                                                'id' => 'discount_type',
                                                'class' => 'form-control' )) }}
									</div>
								</div>
