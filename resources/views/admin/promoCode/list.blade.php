						...
						<table id="list-table" class="table table-striped table-bordered no-wrap list-data custom-table custom-table-second-column">
							<thead>
								...
								@endif
									...
									<th>@lang('custom_admin.label_promo_code')</th>
									<th>@lang('custom_admin.label_discount_type')</th>
									<th class="row_price">@lang('custom_admin.label_amount')</th>
									<th>@lang('custom_admin.label_is_one_time_use')</th>
									<th>@lang('custom_admin.label_maximum_number_of_use')</th>
									<th>@lang('custom_admin.label_duration')</th>
