						...
						<table id="list-table" class="table table-striped table-bordered no-wrap list-data custom-table custom-table-first-column">
							<thead>
								...
								@endif
									...
									<th>@lang('custom_admin.label_zip')</th>
									<th>@lang('custom_admin.label_play_type')</th>
									<th>@lang('custom_admin.label_gender')</th>
									<th>@lang('custom_admin.label_rating')</th>
									<th>@lang('custom_admin.label_amount') ($)</th>
									<th>@lang('custom_admin.label_max_regis_allowed')</th>
