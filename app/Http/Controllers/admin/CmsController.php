        ...
        try {
            ...
            if ($request->isMethod('POST')) {
                ...
                if ($validator->fails()) {
                    ...
                    $saveData['is_home_page']               = $request->is_home_page ? 'Y' : 'N';
                    ...
                    $saveData['banner_image_title']         = $request->banner_image_title ?? null;
                    $saveData['banner_image_alt']           = $request->banner_image_alt ?? null;
                    $saveData['featured_image_title']       = $request->featured_image_title ?? null;
                    $saveData['featured_image_alt']         = $request->featured_image_alt ?? null;
                    $saveData['other_image_title']          = $request->other_image_title ?? null;
                    $saveData['other_image_alt']            = $request->other_image_alt ?? null;
        ...
        try {
            ...
            if ($request->isMethod('POST')) {
                ...
                if ($validator->fails()) {
                    ...
                    $updateData['is_home_page']             = $request->is_home_page ? 'Y' : 'N';
                    ...
                    $updateData['banner_image_title']       = $request->banner_image_title ?? null;
                    $updateData['banner_image_alt']         = $request->banner_image_alt ?? null;
                    $updateData['featured_image_title']     = $request->featured_image_title ?? null;
                    $updateData['featured_image_alt']       = $request->featured_image_alt ?? null;
                    $updateData['other_image_title']        = $request->other_image_title ?? null;
                    $updateData['other_image_alt']          = $request->other_image_alt ?? null;
