...
class Controller extends BaseController
{
    ...
    */
    ...
    /*
        * Function name : getZipToLocation
        * Purpose       : This function to get location information based on zip
        * Author        :
        * Created Date  :
        * Modified Date : 
        * Input Params  : zip code
        * Return Value  : Location information
    */
    function getZipToLocation($zipcode = null) {
        $apiKey = env('ZIP_CODE_API_KEY');

        if ($zipcode) {
            $url = "https://www.zipcodeapi.com/rest/".$apiKey."/info.json/".$zipcode."/radians";
